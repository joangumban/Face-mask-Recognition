...
FROM_SPLASH,_ = loadUiType(os.path.join(os.path.dirname(__file__),"mainwindow.ui"))
FROM_Main,_ = loadUiType(os.path.join(os.path.dirname(__file__),"ui2.ui"))
    ...
    def videosurvillance (self):
        ...
        while True:
            ...
            for (box, pred) in zip(locs, preds):
                ...
                v2.rectangle(frame, (startX, startY), (endX, endY), color, 5)
